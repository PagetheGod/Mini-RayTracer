...
{
public:
	Camera(Point3D InCameraCenter = Point3D(-2.f, 2.f, 1.f), float InFocalLength = 1.f, int InSamplePerPixel = 10, float InVerticalFOV = 60.f);
...
public:
	...
	Point3D LookAt = Point3D(13.f, 2.f, 3.f);
